...
width_important = [compute_mark_from_zero_quadratic(v, quadratic_factor=q_factor_linear, linear_factor=-0.5)
...
plt.plot(value_range, width_important, label="Width important w=0.4")
